            ...
            <tr>
                ...
                <td>
                    ...
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" 
                        BackColor="Red" BorderColor="#FF0066" ControlToValidate="TxtKullaniciAdi" 
                        ErrorMessage="Lütfen Boş Doldurmayın!!!"></asp:RequiredFieldValidator>
                </td>
                <td>
                    &nbsp;</td>
            </tr>
            <tr>
                ...
                <td>
                    ...
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" 
                        BackColor="Red" ControlToValidate="TxtEposta" 
                        ErrorMessage="Lütfen Boş Doldurmayın!!!"></asp:RequiredFieldValidator>
                </td>
                <td>
                    &nbsp;</td>
            ...
            <tr>
                ...
                <td>
                    ...
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" 
                        BackColor="Red" ControlToValidate="TextBox3" 
                        ErrorMessage="Lütfen Boş Doldurmayın!!!"></asp:RequiredFieldValidator>
                </td>
                <td>
                    &nbsp;</td>
            ...
            <tr>
                ...
                <td>
                    ...
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" 
                        BackColor="Red" ControlToValidate="TxtParolaTekrar" 
                        ErrorMessage="Lütfen Boş Doldurmayın!!!"></asp:RequiredFieldValidator>
                </td>
                <td>
                    &nbsp;</td>
