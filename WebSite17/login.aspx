...
<body style="background:url('img/arkaplan.jpg');">
    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        ...
        <table class="w-100">
            <tr>
                <td class="auto-style1 text-danger">E-posta</td>
                <td>
                    <asp:TextBox ID="txteposta" runat="server"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td class="auto-style1 text-danger">Şifre:</td>
                <td>
            ...
            <tr>
                ...
                &nbsp;<asp:Button ID="Button1" runat="server" 
                        onclick="Button1_Click" Text="Giriş" class="btn-primary"/>
                    &nbsp;&nbsp;
                    <asp:Label ID="Label1" runat="server" class="text-danger"></asp:Label>
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="~/uyeol.aspx">Üye ol</asp:HyperLink>
                </td>
            </tr>
        </table>
        <br />
